            ...
            do {
                ...
                if (line.length() == 1)   //check if a user entered only one character
                {
                    ...
                    case 'A':   //Add guest
                        ...
                        break;
                    case 'C': // get # of reservations with certain # of guests
                        ...
                        if(total == -1)
                            System.out.println("No parties found with the size specified.\n");
                        else
                            System.out.printf("There are %s parties with %d guests waiting currently.\n\n", total, size);
                        break;
                    case 'P':	// get position of a reservation
